...
import com.projetowebservices.course.entities.Payment;
...
import com.projetowebservices.course.repositories.OrderItemRepository;
import com.projetowebservices.course.repositories.OrderRepository;
import com.projetowebservices.course.repositories.ProductRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {//tudo que está aqui vai acontecer ao executar a aplicação
		...
		p1.getCategories().add(cat2);//get retorna um Set, o qual pode adicionar um tipo category
